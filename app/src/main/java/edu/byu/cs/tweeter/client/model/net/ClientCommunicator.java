...
class ClientCommunicator {
    ...
    <T> T doPost(String urlPath, final Object requestInfo, Map<String, String> headers, Class<T> returnType)
        ...
        System.out.println("Doing a request, should be going to your apigateway");
        System.out.println("request is: " + requestInfo.toString());
        T response = doRequest(urlPath, headers, returnType, requestStrategy);
