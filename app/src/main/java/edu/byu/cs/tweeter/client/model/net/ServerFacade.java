...
public class ServerFacade {
    ...
    private final ClientCommunicator clientCommunicator = getClientCommunicator(SERVER_URL);
    private ClientCommunicator getClientCommunicator(String URL){
    ...
    public LoginResponse login(LoginRequest request, String urlPath) throws IOException, TweeterRemoteException {
        System.out.println("going to login, in the facade");
    ...
    public FollowResponse followTask(FollowRequest request, String urlPath) throws IOException, TweeterRemoteException {
        return clientCommunicator.doPost(urlPath, request, null, FollowResponse.class);
    }

    public unFollowResponse unFollowTask(unFollowRequest request, String urlPath) throws IOException, TweeterRemoteException{
    ...
    public PostStatusReponse postStatus(PostStatusRequest request, String urlPath) throws IOException, TweeterRemoteException {
        return clientCommunicator.doPost(urlPath, request, null, PostStatusReponse.class);
    }
}
